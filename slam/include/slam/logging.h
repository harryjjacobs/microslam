...
#define SLAM_LOG_LEVEL SLAM_LOG_DEBUG
#elif defined(SLAM_LOG_INFO)
#define SLAM_LOG_LEVEL SLAM_LOG_INFO
#elif defined(SLAM_LOG_WARN)
#define SLAM_LOG_LEVEL SLAM_LOG_WARN
#elif defined(SLAM_LOG_ERROR)
#define SLAM_LOG_LEVEL SLAM_LOG_ERROR
#elif defined(SLAM_LOG_FATAL)
#define SLAM_LOG_LEVEL SLAM_LOG_FATAL
#elif defined(SLAM_LOG_NONE)
#define SLAM_LOG_LEVEL SLAM_LOG_NONE
#endif
